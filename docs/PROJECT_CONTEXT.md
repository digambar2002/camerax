...
| [`camera/CameraManager.kt`](file:///c:/Users/digambar2002/AndroidStudioProjects/CameraX/app/src/main/java/com/example/camerax/camera/CameraManager.kt) | Direct Camera2 API implementation. Operates in zero-copy Surface mode targeting the `MediaCodecEncoder` surface directly. Bypasses YUV memory copies. |
...
| [`ui/screens/MainScreen.kt`](file:///c:/Users/digambar2002/AndroidStudioProjects/CameraX/app/src/main/java/com/example/camerax/ui/screens/MainScreen.kt) | Jetpack Compose Material 3 UI with dark theme, preview overlay, controls, status indicators, and resolution/FPS selectors. |
